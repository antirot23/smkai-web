...
export const MinigameSection = () => {
  return (
    <section className="py-20 bg-bg-primary relative overflow-hidden border-t border-border-subtle/50">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            <RotlessText variant="normal" className="text-text-secondary max-w-md mx-auto lg:mx-0">
              We're building platforms for deeper thinking, but everyone needs a tiny break. Tilt your phone to collect the glowing nodes.
            </RotlessText>
          </div>
